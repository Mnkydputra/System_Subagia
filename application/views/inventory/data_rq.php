            ...
            <table class="table" id="table_id">
              ...
              <tbody>
                ...
                foreach ($stock as $f) : ?>
                  <tr>
                    <td><?= $no++ ?></td>
                    <td><a class="btn btn-raised btn-round btn-primary click" data-id="<?= $f->id ?>" data-sp="<?= $f->shipref ?>" data-pn="<?= $f->product_name ?>" data-pm="<?= $f->description ?>" data-qt="<?= $f->quantity ?>" data-partner="<?= $f->id_sales_partner ?>">
