  ...
  <div class="row">
    <div class="col-12">
      <div class="alert alert-danger">
        <p> Isi Barang Pesanan atas no Order <?= $no_order ?> </p>
      </div>
              ...
              <form id="addDO" enctype="multipart/form-data" class="form-horizontal" method="post">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" readonly id="po_number" value="<?= $no_order ?>" name="po_number" placeholder="Pre Order Number" class="form-control">
                  </div>
            ...
            <table class="table" id="table_id">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><?= $no++ ?></td>
                    <td><a class="btn btn-raised btn-round btn-primary click" data-id="<?= $stock->id ?>" data-awb="<?= $stock->awb ?>" data-shipref="<?= $stock->shipref ?>" , data-product_number="<?= $stock->product_number ?>" data-product_desc="<?= $stock->product_desc ?>" data-quantity="<?= $stock->quantity ?>" data-pallet="<?= $stock->pallet ?>" data-cbm="<?= $stock->cbm ?>">
                        <?= $stock->awb ?>
                      </a>
                    </td>
                    <td><?= $stock->shipref ?></td>
        ...
        $.ajax({
          ...
          success: function(e) {
            if (e = "sukses") {
              ...
              window.location.href = '<?= base_url('i/P_requirment/p_rq/' . $no_order) ?>'
            } else {
